...
export function Sermones() {
  ...
  const loadVideos = useCallback(async (reset) => {
    ...
    try {
      ...
      console.log("🔎 QUERY RESULT:", { data, dbError });
  ...
  return (
    <div className="w-full max-w-none px-6 py-12">
      ...
      <input
        ...
        className="w-full mb-6 p-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        value={search}
